      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left mb-12 lg:mb-0 animate-fade-in">
            <h1 className="mb-6">
              Build beautiful <span className="text-gradient">experiences</span>
            </h1>
            <p className="text-lg md:text-xl text-foreground/70 mb-8 max-w-2xl mx-auto lg:mx-0">
              Create stunning user interfaces that captivate your audience and elevate your brand. Our solutions combine beautiful design with powerful functionality.
            </p>
